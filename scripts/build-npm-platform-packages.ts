 ...
 * behind `npx t3` / `npm i -g t3`: one `@aaditagrawal/t3code-<platformKey>` package per
 ...
 *
 *   @aaditagrawal/t3code-<platformKey>/      archive contents flattened + package.json
 *   @aaditagrawal/t3code-<platformKey>.tgz   the same tree as an npm tarball
...
export const NPM_PLATFORM_PACKAGE_SCOPE = "@aaditagrawal";
export const NPM_LAUNCHER_PACKAGE_NAME = "@aaditagrawal/t3code";
...
export function npmPlatformPackageReadme(platformKey: CliArchivePlatformKey): string {
  return [
    ...
    "```",
    "",
    "Source and documentation: https://github.com/aaditagrawal/t3code",
    "",
  ].join("\n");
}
...
try {
  ...
  process.stderr.write(
    [
      ...
      "The desktop app and release archives are at https://github.com/aaditagrawal/t3code/releases",
      "",
    ].join("\\n"),
  );
  process.exit(1);
...
const command = Command.make(
  ...
  Command.withDescription(
    "Build the t3 launcher and @aaditagrawal/t3code-<platform> npm packages from CLI release archives.",
  ),
);

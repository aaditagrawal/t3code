...
const bundleId = "com.t3tools.t3code.fork.dev";
        ...
        if (platform === "ios") {
          ...
          yield* command(
            ...
            [
              "xcodebuild",
              "-workspace",
              path.join(mobile, "ios/T3CodeForkDev.xcworkspace"),
              "-scheme",
              "T3CodeForkDev",
              "-configuration",
              "Debug",
          ...
          yield* command(
            ...
            [
              ...
              "install",
              device,
              path.join(output, "Build/Products/Debug-iphonesimulator/T3CodeForkDev.app"),
            ],
            true,
          );
        } else {

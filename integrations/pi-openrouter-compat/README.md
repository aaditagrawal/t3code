...
very large output limit. This extension omits near-context catalog-derived limits and lets OpenRouter
and the selected model choose the output limit. Explicit, ordinary-sized request limits are preserved;
the extension does not impose a replacement cap.

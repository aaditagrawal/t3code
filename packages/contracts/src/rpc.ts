...
const WsHermesGatewayCreateEnrollmentRpc = Rpc.make(WS_METHODS.hermesGatewayCreateEnrollment, {
...
const WsHermesGatewayGetInstanceStatusRpc = Rpc.make(WS_METHODS.hermesGatewayGetInstanceStatus, {
  payload: HermesGatewayGetInstanceStatusInput,
  success: HermesGatewayInstanceStatus,
  error: Schema.Union([HermesGatewayManagementError, EnvironmentAuthorizationError]),
});

const WsHermesGatewayListInstancesRpc = Rpc.make(WS_METHODS.hermesGatewayListInstances, {
  payload: Schema.Struct({}),
  success: HermesGatewayListInstancesResult,
  error: Schema.Union([HermesGatewayManagementError, EnvironmentAuthorizationError]),
});

const WsHermesGatewayRenameInstanceRpc = Rpc.make(WS_METHODS.hermesGatewayRenameInstance, {
  payload: HermesGatewayRenameInstanceInput,
  success: HermesGatewayRenameInstanceResult,
  error: Schema.Union([HermesGatewayManagementError, EnvironmentAuthorizationError]),
});

const WsHermesGatewayRevokeInstanceRpc = Rpc.make(WS_METHODS.hermesGatewayRevokeInstance, {
  payload: HermesGatewayRevokeInstanceInput,
  success: HermesGatewayRevokeInstanceResult,
  error: Schema.Union([HermesGatewayManagementError, EnvironmentAuthorizationError]),
});

const WsHermesGatewayRemoveInstanceRpc = Rpc.make(WS_METHODS.hermesGatewayRemoveInstance, {
...
const WsExistingThreadsListRpc = Rpc.make(WS_METHODS.existingThreadsList, {
...
const WsExistingThreadsImportRpc = Rpc.make(WS_METHODS.existingThreadsImport, {

...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server exposes the lightweight pullRequests.summary RPC. Clients fall back to the older
      pullRequests.detail RPC when absent so mixed-version environments keep linked PR status. */
  pullRequestSummary: Schema.optionalKey(Schema.Boolean),

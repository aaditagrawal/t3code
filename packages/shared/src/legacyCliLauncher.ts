 ...
 * executable in the sibling `@aaditagrawal/t3code-<platform>-<arch>` package.
 *
...
const executable = join(dirname(require.resolve("@aaditagrawal/t3code-" + process.platform + "-" + process.arch + "/package.json")), executableName);

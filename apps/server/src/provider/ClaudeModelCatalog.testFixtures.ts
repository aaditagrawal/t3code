...
const gatewayRuntime = {
  ...runtime,
  modelSuffixes: { contextWindow: { expanded: "[1m]" } },
};
...
export const SYNTHETIC_CLAUDE_MODEL_CATALOG: ClaudeModelCatalog = {
  models: [
    {
      model: {
        slug: SYNTHETIC_CLAUDE_GATEWAY_MODEL,
        name: "Claude Synthetic Gateway",
        isCustom: false,
        capabilities: {
          optionDescriptors: [effort, gatewayContextWindow],
        },
      },
      runtime: gatewayRuntime,
      compatibility: { modelId: "sonnet" },
    },
    {
      model: {

/**
 * PrimeAgentDriver — `ProviderDriver` bundle for the Prime Intellect
 * `prime-agent` CLI.
 *
 * Maintenance capabilities are manual-only: T3 Code reports the installed
 * version and leaves updates to the Prime Agent CLI.
 *
 * @module provider/Drivers/PrimeAgentDriver
 */

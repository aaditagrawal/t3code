...
// Policies target upstream releases, independently of the fork's release version.
// Update this baseline when syncing a newer upstream release.
const UPSTREAM_COMPATIBILITY_VERSION = "0.0.42";
...
export function resolveProviderCompatibility(
  ...
  version: string | null,
  t3CodeVersion = UPSTREAM_COMPATIBILITY_VERSION,

...
const DESKTOP_RENDERER_ORIGINS = [`${URL_SCHEME}://app`, `${URL_SCHEME_DEV}://app`];
...
export function assetResponseOptions(asset: Extract<ResolvedAsset, { kind: "file" }>) {
...
export const assetFileResponse = Effect.fn("assetFileResponse")(function* (
  asset: Omit<Extract<ResolvedAsset, { kind: "file" }>, "kind"> & { readonly kind?: "file" },
  rangeHeader?: string,

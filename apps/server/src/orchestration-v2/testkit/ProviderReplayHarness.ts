import type { MigrationLineageError } from "../../persistence/MigrationLineage.ts";
...
>(
  ...
  options: {
    readonly databaseLayer?: Layer.Layer<
      SqlClient.SqlClient,
      MigrationError | MigrationLineageError | PlatformError.PlatformError | SqlError
    >;
...
>(
  ...
  Error | MigrationError | MigrationLineageError | PlatformError.PlatformError | SqlError
> {

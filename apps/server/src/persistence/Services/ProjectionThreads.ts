...
export const ProjectionThread = Schema.Struct({
  ...
  titleRegenerationFailureRequestId: Schema.optional(Schema.NullOr(CommandId)),
  titleRegenerationFailureAt: Schema.optional(Schema.NullOr(IsoDateTime)),
  titleRegenerationFailureError: Schema.optional(Schema.NullOr(Schema.String)),

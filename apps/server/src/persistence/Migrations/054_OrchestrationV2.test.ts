  ...
  it.effect("upgrades released schema 58 through the latest migrations", () =>
    Effect.gen(function* () {
      ...
      const deployedHistory =
        yield* sql`SELECT migration_id, name FROM effect_sql_migrations WHERE migration_id BETWEEN 48 AND 58 ORDER BY migration_id`;
      ...
      assert.deepStrictEqual(migrations, [
        ...
        { migration_id: 57, name: "ProjectionThreadTitleState" },
        { migration_id: 58, name: "PullRequestFilesViewed" },

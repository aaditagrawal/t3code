    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.titleRegenerationError ?? null},
        ...
        DO UPDATE SET
          ...
          title_regeneration_error = excluded.title_regeneration_error,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          title_regeneration_error AS "titleRegenerationError",

...
describe("instance-scoped model selection", () => {
  ...
  it("keeps Antigravity and fork provider kinds available", () => {
    expect(ProviderDriverKind.make("antigravity")).toBe("antigravity");
    expect(ProviderDriverKind.make("ohMyPi")).toBe("ohMyPi");
    expect(ProviderDriverKind.make("hermes")).toBe("hermes");
    expect(ProviderDriverKind.make("pi")).toBe("pi");
    expect(ProviderDriverKind.make("fx")).toBe("fx");
    expect(ProviderDriverKind.make("amp")).toBe("amp");
    expect(ProviderDriverKind.make("copilot")).toBe("copilot");
    expect(ProviderDriverKind.make("geminiCli")).toBe("geminiCli");
    expect(ProviderDriverKind.make("kilo")).toBe("kilo");
    expect(ProviderDriverKind.make("droid")).toBe("droid");
  });

      ...
      <Collapsible open={props.confirmationOpen} onOpenChange={props.onConfirmationChange}>
        ...
        <CollapsiblePanel>
          <div className="pt-3">
            ...
            >
              <h4 className="text-xs leading-[1.125rem] font-semibold text-foreground">
                Deregister server
              </h4>
              <p className="mt-1 text-xs leading-[1.125rem] text-muted-foreground">
                “{environment.label}” will be removed from this account.
              </p>
              <p className="mt-4 max-w-xl text-xs leading-[1.125rem] text-muted-foreground">
      ...
      <div>
        ...
        {isInitialLoad ? (
          ...
          <Empty className="min-h-64 gap-4 border-t px-6 py-10 md:p-10">
            ...
            <EmptyHeader>
              <EmptyTitle className="text-base leading-6">No T3 Connect environments</EmptyTitle>

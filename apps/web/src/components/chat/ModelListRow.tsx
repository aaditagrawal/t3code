  ...
  const row = (
    <ComboboxItem
      ...
      className={cn(
        ...
        "hover:bg-row-hover data-highlighted:bg-row-hover data-selected:ring-0 [&[data-highlighted][data-selected]]:bg-row-hover",
    ...
    >
      <div className="min-w-0 flex-1 text-left">
        <div className="flex min-w-0 items-center gap-2">
          ...
          {props.showNewBadge ? (
            <span
              className="shrink-0 rounded border border-update/35 bg-update/15 px-0.5 py-px text-xs font-bold uppercase leading-none tracking-wide text-update-foreground"
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        {props.jumpLabel ? (
          <Kbd className="h-4 min-w-0 rounded-sm px-1.5">{props.jumpLabel}</Kbd>
        ) : null}
        <Tooltip>
          <TooltipTrigger
            render={

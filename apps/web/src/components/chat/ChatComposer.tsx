...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  useCommitRef(attachmentTargetKeyRef, attachmentTargetKey);
  ...
  const selectedRuntimeModeConfig = getRuntimeModeConfig(selectedProvider);
  const runtimeModeOptions = getRuntimeModeOptions(selectedProvider).map((mode) => ({
    mode,
    ...selectedRuntimeModeConfig[mode],
  }));

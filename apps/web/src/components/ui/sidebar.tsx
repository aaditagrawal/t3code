  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        >
          <div
            className="sidebar-translucent flex h-full w-full flex-col bg-sidebar surface-grain group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5"
            data-sidebar="sidebar"
...
function SidebarMenuSkeleton({
  ...
  // Keep each skeleton width fixed for its mounted lifetime.

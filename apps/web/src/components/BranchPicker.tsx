      ...
      <ComboboxPopup {...popupProps}>
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="relative min-h-0 w-full max-h-56 flex-1 overflow-hidden">
            <ComboboxListVirtualized className="size-full min-w-0" padding="none">
              <LegendList<string>
                ref={branchListRef}
                data={filteredItems}
                ...
                render={
                  ...
                  >
                    <span className="flex min-w-0 items-center gap-1.5 font-medium text-muted-foreground">
                      <RefreshIcon aria-hidden="true" size="xs" tone="muted" className="shrink-0" />
...
export function BranchPickerRefItem({
  ...
  return (
    ...
    >
      <div className="flex w-full min-w-0 items-center justify-between gap-2 -me-0.5">

  ...
  if (kind === "comment") {
    return (
      ...
      >
        ...
        <p className="min-w-0 flex-1 whitespace-pre-wrap text-xs leading-5">{displayedText}</p>
        {onDelete ? (
          <Button
  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex items-center gap-1">
        <span className="mr-auto text-xs text-muted-foreground/70">⌘/Ctrl Enter to send</span>
        <Button

  ...
  return (
    <div className="grid h-[3.875rem] grid-cols-[0.375rem_minmax(0,1fr)_auto] grid-rows-[1.25rem_1.125rem_1rem] items-center gap-x-2 rounded-md px-1.5 py-1">
      ...
      <span className="col-start-2 row-start-1 flex min-w-0 items-baseline gap-2">
        ...
        {role ? (
          <span className="max-w-28 shrink-0 truncate rounded-sm border border-border/60 px-1 font-mono text-xs text-muted-foreground">
            {role}
          </span>
        ) : null}
      </span>
      <span className="col-start-3 row-start-1 min-w-14 text-right font-mono text-xs text-muted-foreground/80">
      ...
      <span className="col-start-2 col-end-4 row-start-3 truncate font-mono text-xs tabular-nums text-muted-foreground/70">
        {metadata.join(" · ")}
      </span>
  ...
  return (
    <div>
      <button
        ...
        aria-expanded={open}
        className={cn(
          "mt-2 flex w-full items-center gap-1.5 rounded-sm px-1.5 text-left text-xs font-medium uppercase tracking-wider hover:bg-accent/40",
          phase.state === "done"
            ? "text-success-foreground"
            : phase.state === "running"
              ? "text-info-foreground"
...
function ExpandedWorkflowSection({
  ...
  return (
    <section className="rounded-lg border border-border/50 bg-card/30 p-1.5">
      <div className="flex items-center gap-2 px-1.5 pt-0.5 text-xs font-medium uppercase tracking-wider text-muted-foreground">
  ...
  return (
    <section>
      ...
      >
        ...
        <span className="ml-auto flex items-center gap-1.5 font-mono text-xs text-muted-foreground/80">
...
export function AgentsPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <ScrollArea className="min-h-0 flex-1">
        <div className="flex flex-col gap-2 p-2">
          ...
          {model.directAgents.length > 0 ? (
            <section>
              <div className="px-1.5 pt-1 text-xs font-medium uppercase tracking-wider text-muted-foreground">
                Direct spawns
              </div>
      ...
      <footer className="flex items-center justify-between border-t border-border/60 px-3 py-1.5 font-mono text-xs text-muted-foreground">

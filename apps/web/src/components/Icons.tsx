    ...
    return (
      <svg {...props} viewBox="0 0 32 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#opencode__clip0_1311_94969)">
          <path data-opencode-hole="true" d="M24 32H8V16H24V32Z" fill="currentColor" opacity={0.45} />
...
// Oh My Pi — official pi mark with its orange plug connector.
export const OhMyPiIcon: Icon = ({ className, monochrome, ...props }) => {
  const accentColor = monochrome ? "currentColor" : "#f97316";
  const connectorPinColor = monochrome ? "var(--background, #0d0d0d)" : "#0d0d0d";
  ...
  return (
    ...
    >
      ...
      <rect x="71" y="55" width="20" height="16" rx="3" fill={accentColor} />
      <rect x="76" y="59" width="3" height="8" rx="1" fill={connectorPinColor} />
      <rect x="82" y="59" width="3" height="8" rx="1" fill={connectorPinColor} />
      <circle cx="18" cy="14" r="2" fill={accentColor} opacity="0.8" />
      <circle cx="102" cy="14" r="2" fill={accentColor} opacity="0.8" />
    </svg>
  );
};

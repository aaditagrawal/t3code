...
export function BrowserDeviceToolbar({
  ...
  return (
    <div
      className="w-(--toolbar-width) h-(--toolbar-height) sticky left-0 top-0 z-50 flex items-center gap-0.5 overflow-x-auto border-b border-border/70 bg-background/95 px-1.5 shadow-xs backdrop-blur-md [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      style={{

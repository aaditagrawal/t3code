          ...
          ? [
              {
                ...
                onPress: () =>
                  navigation.dispatch(
                    StackActions.push("AddProject", { incomingShareId: props.incomingShareId }),
                  ),
              },
            ]
          : []
                ...
                <MaterialButton
                  ...
                  onPress={() =>
                    catalogState.hasReadyEnvironment
                      ? navigation.dispatch(
                          StackActions.push("AddProject", { incomingShareId: routeShareId }),
                        )

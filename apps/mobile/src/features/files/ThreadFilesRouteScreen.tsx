  ...
  const fileMenuActions = useMemo(() => {
    ...
    return [
      ...
      resolvedActiveMode === "preview" && (isBrowserFile || isImageFile || isVideoFile)
        ...
        : null,
      // Android source views have no native pull-to-refresh after the canvas
      // refactor, so keep the explicit refresh action in the shared menu model.
